  ...
  [ProjectsGroup.GameDevelopment]: {
    ...
    projects: [
      ...
      },
      {
        ...
        description: (
          <>
            Another code challenge, this time in HTML and JavaScript. It's an advanced version of
            Tic Tac Toe.
            <br />
            The game creates a peer-to-peer connection between players and allows them to play
            against each other. It works without a server, all data is exchanged directly between
    ...
    projects: [
      {
        ...
        description: (
          <>
            Blender is my software of choice for creating 3D renders. I've always been fascinated by
            photorealistic graphics, so I started learning techniques to create them.
