...
import { ProjectsGroup } from "./lib/sections-info"
...
function App() {
  ...
  useEffect(() => {
    ...
    const sectionContainers = Object.values(ProjectsGroup).map((section) =>
  ...
  const scrollToSection = (section: ProjectsGroup) => {
    ...
    <Background className="flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        ...
        <Button
          ...
          onClick={() => {
            scrollToSection(ProjectsGroup.WebDevelopment)
          }}
